...
def getSvhnModel(init_p_dict, rng, srng):
    ...
    layer = LayerConv(layer, 64, (3,3), (1,1), 'half', rng, srng,
...
def main():
    ...
    init_model_file = 'svhn_model_ternary_tanh.npz'
    ...
    # Create model
    global parameters
    layer, parameters = getSvhnModel(initial_parameters, rng, srng)
    ...
    # p_vals.
    model_file = 'svhn_model_ternary_sign_from_tanh.npz'
