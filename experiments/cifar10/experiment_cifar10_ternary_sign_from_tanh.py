...
def getCifar10Model(init_p_dict, rng, srng):
    '''
...
def main():
    ...
    init_model_file = 'cifar10_model_ternary_tanh.npz'
    ...
    # Create model
    global parameters
    layer, parameters = getCifar10Model(initial_parameters, rng, srng)
    ...
    # p_vals.
    model_file = 'cifar10_model_ternary_sign_from_tanh.npz'
